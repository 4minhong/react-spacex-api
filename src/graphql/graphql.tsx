...
export type GetNextLaunchesQueryVariables = Exact<{ [key: string]: never; }>;


export type GetNextLaunchesQuery = { __typename?: 'Query', launchNext?: { __typename?: 'Launch', launch_date_local?: any | null, id?: string | null, launch_success?: boolean | null, details?: string | null, mission_name?: string | null, launch_site?: { __typename?: 'LaunchSite', site_name_long?: string | null } | null, links?: { __typename?: 'LaunchLinks', article_link?: string | null, video_link?: string | null } | null, rocket?: { __typename?: 'LaunchRocket', rocket_name?: string | null, rocket_type?: string | null } | null } | null };
...
export const GetNextLaunchesDocument = gql`
...
/**
 * __useGetNextLaunchesQuery__
 *
 * To run a query within a React component, call `useGetNextLaunchesQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetNextLaunchesQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetNextLaunchesQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetNextLaunchesQuery(baseOptions?: Apollo.QueryHookOptions<GetNextLaunchesQuery, GetNextLaunchesQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetNextLaunchesQuery, GetNextLaunchesQueryVariables>(GetNextLaunchesDocument, options);
      }
export function useGetNextLaunchesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetNextLaunchesQuery, GetNextLaunchesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetNextLaunchesQuery, GetNextLaunchesQueryVariables>(GetNextLaunchesDocument, options);
        }
export type GetNextLaunchesQueryHookResult = ReturnType<typeof useGetNextLaunchesQuery>;
export type GetNextLaunchesLazyQueryHookResult = ReturnType<typeof useGetNextLaunchesLazyQuery>;
export type GetNextLaunchesQueryResult = Apollo.QueryResult<GetNextLaunchesQuery, GetNextLaunchesQueryVariables>;